...
CREATE TABLE "ChatbotConfig" (
    ...
    "personality" TEXT NOT NULL DEFAULT 'Gentil, amigavel, educado, profissional',
...
-- AddForeignKey
ALTER TABLE "ChatbotConfig" ADD CONSTRAINT "ChatbotConfig_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
